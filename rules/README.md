...
The base GTDo setup. Together they automate the categorization and add a safety net to outgoing email.
...
## Customization rules (add after a few weeks of GTDo use)
