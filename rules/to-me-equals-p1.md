...
The second foundational rule of GTDo. Automatically marks every email where **you are in the To field** as priority **P1**.
...
This is one of the most important — and most ignored — distinctions in email etiquette. GTDo encodes it as a rule: every email addressed directly to you is **P1** (priority 1) by default.
...
7. **Next** → name the rule (e.g., "GTDo: To = me → P1") → **Finish**
...
## How this combines with the GTDo Search Folder

Together with the [GTDo Main search folder](../search-folders/gtdo-main.md), this rule produces the daily workflow:

1. New email arrives
2. If you're in To → automatically P1 → appears in the GTDo search folder grouped under P1
3. If you're in CC → no category → appears in the GTDo search folder under "Unread"
