...
The OWN Main search folder requires the **Advanced Query Builder** to be enabled in Outlook (it uses OR logic). See [`docs/enable-query-builder.md`](../docs/enable-query-builder.md) for the setup.
